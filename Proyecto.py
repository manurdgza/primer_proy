...
def litros_persona(a,b):
    consumo_persona=(precio//personas)
    return "El consumo por persona en su casa es de " "%.2f"%(consumo_persona), "litros" #YA SIRVE
...
if(opcion_agua==1):
    ...
    consumo_persona=(litros_persona(consumo_agua,personas))
    print (consumo_persona)
